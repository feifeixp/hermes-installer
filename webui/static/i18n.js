...
const LOCALES = {
  ...
  zh: {
    ...
    cancelling: '正在取消…',
    cancel_failed: '取消失败：',
    mic_denied: '麦克风权限被拒绝，请检查浏览器权限设置。',
    ...
    mcp_save: '保存',
    mcp_cancel: '取消',
    mcp_name_required: '服务器名称不能为空。',
    mcp_url_required: 'HTTP 传输需要提供 URL。',
    mcp_command_required: 'stdio 传输需要提供命令。',
    mcp_saved: 'MCP 服务器已保存。',
    mcp_save_failed: 'MCP 服务器保存失败。',
    mcp_delete_confirm_title: '删除 MCP 服务器',
    mcp_delete_confirm_message: '确定要删除 MCP 服务器「{0}」吗？此操作不可撤销。',
    ...
    edit_failed: '编辑失败：',
    regen_failed: '重新生成失败：',
    reconnect_active: '回复仍在生成中。就绪后重新加载？',
    reconnect_finished: '上次离开时回复正在生成，消息可能已更新。',
    // approval card
    approval_heading: '需要确认',
    approval_desc_prefix: '检测到危险命令',
    approval_btn_once: '允许本次',
    approval_btn_once_title: '允许此命令执行一次（回车）',
    approval_btn_session: '本次会话允许',
    approval_btn_session_title: '当前对话会话内允许',
    approval_btn_always: '始终允许',
    approval_btn_always_title: '始终允许此命令模式',
    approval_btn_deny: '拒绝',
    approval_btn_deny_title: '拒绝 — 不执行此命令',
    approval_responding: '正在回复…',
    clarify_heading: '需要澄清',
    clarify_hint: '选择一个选项，或在下方输入你的答案。',
    clarify_other: '其他',
    clarify_send: '发送',
    clarify_input_placeholder: '输入你的回复…',
    clarify_responding: '正在回复…',
    untitled: '未命名',
    n_messages: (n) => `${n} 条消息`,
    load_older_messages: '↑ 上滑或点击加载更早的消息',
    queued_label: '回复后发送',
    queued_count: (n) => n === 1 ? '1 条排队中' : `${n} 条排队中`,
    queued_cancel: '取消排队消息',
    model_unavailable: '（不可用）',
    model_unavailable_title: '此模型已不在当前提供商列表中',
    provider_mismatch_warning: (m,p)=>`"${m}" 可能与当前配置的提供商 (${p}) 不兼容。仍可尝试发送，或在终端中执行 \`hermes model\` 切换模型。`,
    ...
    model_scope_advisory: '从下一条消息开始应用于此对话。',
    model_scope_toast: '从下一条消息开始应用于此对话。',
    // commands.js
    cmd_clear: '清除对话消息',
    ...
    cmd_queue: '将消息排队到下一轮',
    cmd_interrupt: '取消当前轮次并发送新消息',
    cmd_steer: '在不中断 Agent 的情况下注入中途修正',
    cmd_queue_no_msg: '用法：/queue <消息>',
    cmd_queue_not_busy: '无活跃任务 — 直接发送即可',
    cmd_queue_confirm: '消息已排队',
    cmd_interrupt_no_msg: '用法：/interrupt <消息>',
    cmd_interrupt_confirm: '已中断 — 正在发送新消息',
    cmd_steer_no_msg: '用法：/steer <消息>',
    cmd_steer_fallback: 'Steer 不可用 — 已排队到下一轮',
    cmd_steer_delivered: 'Steer 已送达 — Agent 将在下次工具结果中看到',
    steer_leftover_queued: 'Steer 已排队到下一轮',
    busy_steer_fallback: 'Steer 不可用 — 已排队到下一轮',
    busy_interrupt_confirm: '已中断 — 正在发送新消息',
    settings_label_busy_input_mode: '忙碌输入模式',
    settings_desc_busy_input_mode: '控制 Agent 运行时发送消息的行为。排队：等待；中断：取消当前并重新开始；Steer：在不中断的情况下注入修正（Agent 或流不可用时回退到排队）。',
    settings_busy_input_mode_queue: '排队跟进',
    ...
    cmd_undo:'撤销最后一轮对话',
    cmd_btw:'提问（临时问题）',
    cmd_btw_usage:'/btw <问题> — 使用会话上下文提问',
    cmd_background:'在后台运行提示词',
    cmd_background_usage:'/background <提示词> — 并行运行，不阻塞',
    btw_asking:'正在提问...',
    btw_label:'临时问题 — 不记入历史',
    btw_done:'问题已回答',
    btw_no_answer:'未收到回复。',
    btw_failed:'问题失败：',
    bg_running:'后台运行中...',
    ...
    bg_no_answer:'（无回答）',
    bg_failed:'后台任务失败：',
    undo_exchange:'撤销最后一轮',
    cmd_status:'显示会话信息',
    cmd_voice:'开关麦克风输入',
    stream_stopped:'回复已停止。',
    no_active_task:'无活跃任务可停止。',
    cancel_unavailable:'取消不可用。',
    retry_failed:'重试失败：',
    undo_failed:'撤销失败：',
    ...
    title_set:'标题已设置为',
    cmd_webui_only_session:'此命令不适用于 CLI 导入的会话。',
    cmd_voice_use_mic:'点击输入框中的麦克风按钮。',
    usage_heading:'Token 用量',
    usage_default_model:'默认',
    usage_unknown:'未知',
    usage_input_tokens:'输入 Token',
    usage_output_tokens:'输出 Token',
    usage_total:'总计 Token',
    usage_estimated_cost:'预估费用',
    usage_settings_tip:'注意：费用估计仅供参考。',
    usage_load_failed:'加载用量失败：',
    usage_personality_none:'无',
    no_personalities: '未找到人格（请添加到 ~/.hermes/personalities/）',
    available_personalities: '可用人格：',
    personality_switch_hint: '\n\n使用 `/personality <名称>` 切换，或 `/personality none` 清除。',
    personalities_load_failed: '加载人格失败',
    personality_cleared: '人格已清除',
    personality_set: '人格：',
    failed_colon: '失败：',
    // ui.js
    no_workspace: '无工作区',
    terminal_open_title: '打开工作区终端',
    terminal_no_workspace_title: '选择工作区以打开终端',
    terminal_title: '终端',
    terminal_clear: '清屏',
    ...
    terminal_error: '终端错误',
    workspace_empty_no_path: '未选择工作区。在设置 → 工作区中设置后即可浏览文件。',
    ...
    created: '已创建',
    create_failed: '创建失败：',
    new_folder_prompt: '新文件夹名：',
    folder_created: '已创建文件夹',
    folder_create_failed: '创建文件夹失败：',
    workspace_auto_create_folder: '如果不存在则自动创建文件夹',
    folder_add_as_space_btn: '添加为空间',
    folder_add_as_space_msg: '将此文件夹添加为工作区列表中的新空间？',
    folder_add_as_space_title: '添加为空间？',
    remove_title: '移除',
    empty_dir: '（空）',
    upload_failed: '上传失败：',
    all_uploads_failed: (n) => `全部 ${n} 个上传均失败`,
    archive_extracted: (n, c) => `从 ${c} 个压缩包中解压了 ${n} 个文件`,
    session_pin: '置顶对话',
    session_unpin: '取消置顶',
    session_pin_desc: '将此对话保持在列表顶部',
    ...
    session_archive_desc: '隐藏此对话，直到显示归档',
    ...
    session_duplicate_desc: '创建具有相同工作区和模型的副本',
    ...
    settings_section_preferences_meta: 'Hermes Web UI 的默认值和行为。',
    ...
    settings_desc_model: '用于新对话。现有对话保持其已选模型。',
    settings_label_send_key: '发送键',
    ...
    settings_label_sidebar_density: '侧栏密度',
    cmd_reasoning: '切换思考过程可见性（显示/隐藏）、设置努力程度或查看当前状态',
    settings_label_cli_sessions: '显示 Agent 会话',
    ...
    settings_saved_pw: '设置已保存 — 密码保护已启用，此浏览器保持登录状态',
    ...
    import: '导入',
    // Settings detail
    settings_label_sound: '通知音效',
    settings_desc_sound: '助手完成回复时播放音效。',
    settings_label_notifications: '浏览器通知',
    settings_desc_notifications: '应用在后台时，回复完成后显示系统通知。',
    settings_desc_token_usage: '在每个助手回复下方显示输入/输出 Token 计数。也可通过 /usage 切换。',
    settings_sidebar_density_compact: '紧凑',
    settings_sidebar_density_detailed: '详细',
    settings_desc_sidebar_density: '控制侧栏会话列表中显示的元数据量。',
    settings_label_auto_title_refresh: '自动标题刷新',
    settings_auto_title_refresh_off: '关闭',
    settings_auto_title_refresh_5: '每 5 轮',
    settings_auto_title_refresh_10: '每 10 轮',
    settings_auto_title_refresh_20: '每 20 轮',
    settings_desc_auto_title_refresh: '根据最新对话自动重新生成会话标题，随对话发展保持标题相关性。需要配置 LLM 标题生成模型。',
    settings_desc_cli_sessions: '将 Hermes CLI (state.db) 中的会话合并到会话列表。点击 CLI 会话可导入并继续对话。',
    settings_desc_sync_insights: '将 WebUI Token 用量镜像到 state.db，以便 hermes /insights 包含浏览器会话数据。默认关闭。',
    settings_desc_check_updates: '当 WebUI 或 Agent 有新版本时显示横幅。后台定期运行 git fetch。',
    settings_desc_bot_name: '助手在整个 UI 中的显示名称。默认为 Hermes。',
    settings_desc_password: '输入新密码以设置或更改。留空保持不变。',
    ...
    providers_oauth_config_yaml_hint: '通过 config.yaml 配置 Token。要更新，请编辑 config.yaml 中的 providers 部分或运行 hermes auth。',
    ...
    // Empty state
    empty_title: '我能帮你做什么？',
    empty_subtitle: '随意提问、运行命令、探索文件或管理定时任务。',
    ...
    onboarding_lead: '快速引导设置将验证 Hermes、保存提供商配置、选择工作区和模型，并可选择设置密码保护。',
    onboarding_back: '返回',
    onboarding_continue: '继续',
    onboarding_skip: '跳过设置',
    onboarding_skipped: '已跳过设置 — 使用现有配置。',
    ...
    onboarding_step_setup_desc: '保存 Hermes 提供商基本配置。',
    onboarding_step_workspace_title: '工作区 + 模型',
    onboarding_step_workspace_desc: '为新会话和对话选择默认值。',
    onboarding_step_password_title: '可选密码',
    onboarding_step_password_desc: '在分享前保护 Web UI。',
    onboarding_step_finish_title: '完成',
    onboarding_step_finish_desc: '检查并进入应用。',
    onboarding_notice_system_ready: 'Hermes Agent 可从 Web UI 访问。',
    onboarding_notice_system_unavailable: 'Hermes Agent 尚未完全就绪。引导程序可以安装它，但提供商设置可能仍需要终端。',
    onboarding_check_agent: 'Hermes Agent',
    onboarding_check_agent_ready: '已检测并可导入',
    ...
    onboarding_check_provider_ready: '准备就绪',
    ...
    onboarding_notice_setup_required: '在此选择简单的提供商路径。高级 OAuth 流程目前仍需在 Hermes CLI 中完成。',
    onboarding_notice_setup_already_ready: '检测到可工作的 Hermes 提供商设置。可以保留或在此替换。',
    onboarding_oauth_provider_ready_title: '提供商已认证',
    onboarding_oauth_provider_ready_body: '此实例配置使用通过 Hermes CLI 设置的 OAuth 提供商（<strong>{provider}</strong>）。无需在此输入 API 密钥 — 点击继续完成设置。',
    onboarding_oauth_provider_not_ready_title: 'OAuth 提供商尚未认证',
    onboarding_oauth_provider_not_ready_body: '此实例配置使用 <strong>{provider}</strong>，它使用 OAuth 而非 API 密钥。在终端中运行 <code>hermes auth</code> 或 <code>hermes model</code> 进行认证，然后重新加载 Web UI。',
    onboarding_oauth_switch_hint: '或选择下方的其他提供商切换到 API 密钥设置：',
    onboarding_notice_workspace: '这些值使用与普通应用相同的设置 API。',
    ...
    provider_category_self_hosted: '开源 / 自托管',
    provider_category_specialized: '专业',
    onboarding_api_key_label: 'API 密钥',
    onboarding_api_key_placeholder: '留空以保留现有密钥',
    onboarding_api_key_help_prefix: '安全保存到 Hermes .env 文件中，使用',
    onboarding_base_url_label: 'Base URL',
    onboarding_base_url_placeholder: 'https://your-endpoint.example/v1',
    onboarding_base_url_help: '用于 OpenAI 兼容路由器、自托管服务器、LiteLLM、Ollama、LM Studio、vLLM 或类似接入点。',
    onboarding_model_label: '默认模型',
    onboarding_workspace_help: '选择 Hermes 在设置完成后用于新对话的模型。',
    onboarding_custom_model_placeholder: 'your-model-name',
    onboarding_custom_model_help: '对于自定义接入点，输入服务器期望的精确模型 ID。',
    onboarding_notice_password_enabled: '已配置密码。仅需输入新密码来替换。',
    onboarding_notice_password_recommended: '可选，但如果要将 UI 暴露到 localhost 之外建议设置。',
    onboarding_password_label: '密码（可选）',
    onboarding_password_placeholder: '留空跳过',
    onboarding_password_help: '密码通过现有的设置 API 存储并在服务端哈希处理。',
    onboarding_notice_finish: '你可以稍后重新打开设置来更改这些配置。',
    ...
    onboarding_password_remains_disabled: '保持禁用',
    onboarding_password_skipped: '暂时跳过',
    onboarding_finish_help: '完成后在设置中保存 <code>onboarding_completed</code> 并将你带入正常应用。',
    onboarding_error_choose_workspace: '继续前请选择工作区。',
    onboarding_error_choose_model: '继续前请选择模型。',
    onboarding_error_provider_required: '继续前请选择设置模式。',
    onboarding_error_base_url_required: '自定义接入点需要提供 Base URL。',
    onboarding_error_workspace_required: '工作区不能为空。',
    onboarding_error_model_required: '模型不能为空。',
    ...
    cron_status_active: '活跃',
    cron_status_running: '运行中…',
    cron_status_needs_attention: '需要注意',
    cron_attention_desc: '此循环任务没有下次运行时间。调度器可能未能计算其下次运行。',
    cron_attention_croniter_hint: 'Gateway 运行时可能缺少 croniter 包。重启带有 cron 支持的 Gateway，然后恢复此任务。',
    cron_attention_resume: '恢复并重新计算',
    cron_attention_run_once: '立即运行一次',
    cron_attention_copy_diagnostics: '复制诊断信息',
    cron_diagnostics_copied: 'Cron 诊断信息已复制',
    cron_next: '下次',
    cron_last: '上次',
    cron_run_now: '立即运行',
    cron_pause: '暂停',
    ...
    cron_schedule_placeholder: '调度',
    cron_prompt_placeholder: '提示词',
    cron_last_output: '上次输出',
    cron_all_runs: '全部运行',
    cron_hide_runs: '隐藏运行',
    cron_no_runs_yet: '（暂无运行）',
    cron_schedule_required_example: '调度为必填（例如 "0 9 * * *" 或 "every 1h"）',
    cron_schedule_required: '调度为必填',
    cron_prompt_required: '提示词为必填',
    ...
    cron_delete_confirm_message: '此操作不可撤销。',
    cron_job_deleted: '任务已删除',
    cron_completion_status: (name, status) => `定时任务 "${name}" ${status}`,
    status_failed: '失败',
    status_completed: '已完成',
    todos_no_active: '此会话中没有活跃任务列表。',
    clear_conversation_title: '清除对话',
    clear_conversation_message: '清除所有消息？此操作不可撤销。',
    clear_failed: '清除失败：',
    skills_no_match: '无匹配技能。',
    linked_files: '关联文件',
    skill_load_failed: '无法加载技能：',
    skill_file_load_failed: '无法加载文件：',
    skill_name_required: '技能名称为必填',
    skill_updated: '技能已更新',
    skill_created: '技能已创建',
    skill_deleted: '技能已删除',
    skill_delete_confirm: '删除技能 "{0}"？',
    skills_empty_title: '选择一个技能',
    skills_empty_sub: '从侧栏选择技能查看其内容，或创建新技能。',
    skills_edit: '编辑',
    skills_delete: '删除',
    skills_back_to: '返回 {0}',
    tasks_empty_title: '选择定时任务',
    tasks_empty_sub: '从侧栏选择任务查看其详情和运行记录，或创建新任务。',
    workspaces_empty_title: '选择一个空间',
    workspaces_empty_sub: '从侧栏选择空间查看其文件和设置，或添加新空间。',
    profiles_empty_title: '选择一个配置',
    profiles_empty_sub: '从侧栏选择 Agent 配置查看和编辑其设置，或创建新配置。',
    ...
    workspace_choose_path_meta: '添加验证后的路径并切换此对话',
    workspace_manage: '管理工作区',
    workspace_manage_meta: '打开空间面板',
    workspace_use_title: '在当前会话中使用',
    workspace_use: '使用',
    workspace_add_path_placeholder: '添加工作区路径（例如 /home/user/my-project）',
    workspace_paths_validated_hint: '路径在保存前会验证为存在的目录。',
    workspace_drag_hint: '拖动排序',
    workspace_reorder_failed: '排序失败',
    ...
    workspace_switch_prompt_message: '输入绝对路径以添加并切换此对话的工作区。',
    workspace_switch_prompt_confirm: '切换',
    workspace_switch_prompt_placeholder: '/Users/you/project',
    workspace_not_added: '工作区未添加',
    workspace_already_saved: '工作区已保存 — 从列表中选择',
    workspace_busy_switch: 'Agent 运行时无法切换工作区',
    discard_file_edits_title: '放弃文件编辑？',
    discard_file_edits_message: '切换工作区将放弃预览中未保存的文件编辑。',
    workspace_switched_to: (name) => `已切换到 ${name}`,
    profiles_no_profiles: '未找到配置。',
    profile_api_keys_configured: 'API 密钥已配置',
    profile_gateway_running: 'Gateway 运行中',
    profile_gateway_stopped: 'Gateway 已停止',
    profile_active: '活跃',
    profile_no_configuration: '无配置',
    profile_skill_count: (count) => `${count} 个技能`,
    profile_use: '使用',
    profile_switch_title: '切换到此配置',
    profile_delete_title: '删除此配置',
    profile_default_label: '（默认）',
    profile_name_placeholder: '配置名称（小写字母、数字、连字符）',
    profile_clone_label: '从活跃配置克隆',
    ...
    profiles_load_failed: '加载配置失败',
    profiles_busy_switch: 'Agent 运行时无法切换配置',
    profile_switched_new_conversation: (name) => `已切换到配置：${name} — 新对话已开始`,
    profile_switched: (name) => `已切换到配置：${name}`,
    profile_name_rule: '仅允许小写字母、数字、连字符、下划线',
    profile_base_url_rule: 'Base URL 必须以 http:// 或 https:// 开头',
    profile_created: (name) => `配置已创建：${name}`,
    profile_delete_confirm_title: (name) => `删除配置 "${name}"？`,
    profile_delete_confirm_message: '此配置的所有会话、设置、技能和记忆将被永久删除。此操作不可撤销。',
    profile_deleted: (name) => `配置已删除：${name}`,
    active_conversation_none: '未选择活跃对话。',
    active_conversation_meta: (title, count) => `${title} · ${count} 条消息`,
    settings_unsaved_changes: '你有未保存的更改。',
    sign_out_failed: '退出失败：',
    disable_auth_confirm_title: '禁用密码保护',
    disable_auth_confirm_message: '任何人都可以访问此实例。',
    auth_disabled: '认证已禁用 — 密码保护已移除',
    disable_auth_failed: '禁用认证失败：',
    bg_error_single: (title) => `"${title}" 遇到错误`,
    bg_error_multi: (count) => `${count} 个会话遇到错误`,
    // skill form
    skill_name: '名称',
    skill_category: '分类',
    ...
    skill_rename_not_supported: '不支持重命名技能。创建新技能并删除旧技能以重命名。',
    skill_metadata: '元数据',
    // cron form
    cron_name_label: '名称',
    cron_name_placeholder: '可选',
    cron_schedule_label: '调度',
    cron_schedule_hint: 'Cron 表达式或简写，如 "every 1h"。',
    cron_prompt_label: '提示词',
    cron_deliver_label: '输出到',
    cron_deliver_local: '本地（仅保存输出）',
    cron_skills_label: '技能',
    cron_skills_placeholder: '添加技能（可选）…',
    cron_skills_edit_hint: '技能列表创建后不可编辑。',
    // workspace form
    workspace_name_label: '名称',
    workspace_name_placeholder: '可选友好名称',
    workspace_path_label: '路径',
    workspace_path_required: '路径为必填',
    workspace_path_readonly: '路径不可更改。仅可重命名。',
    workspace_new_title: '新建空间',
    // profile form
    profile_name_label: '名称',
    profile_base_url_label: 'Base URL',
    profile_api_key_label: 'API 密钥',
    cmd_yolo: '切换 YOLO 模式（跳过确认）',
    yolo_no_session: '无活跃会话',
    yolo_enabled: '⚡ YOLO 模式已开启 — 此会话跳过确认',
    yolo_disabled: 'YOLO 模式已关闭',
    yolo_pill_label: 'YOLO',
    yolo_pill_title_active: 'YOLO 模式活跃 — 点击禁用',
    approval_skip_all: '⚡ 本次会话全部跳过',
    approval_skip_all_title: '跳过本次会话的所有确认提示',
    // composer action tooltips
    composer_send: '发送消息',
    composer_queue: '排队消息',
    composer_interrupt: '中断并发送',
    composer_steer: '引导当前回复',
    composer_stop: '停止生成',
    composer_disabled_clarify: '回复澄清请求',
    composer_disabled_compression: '等待压缩完成',
    composer_disabled_empty: '输入消息以发送',
  },
