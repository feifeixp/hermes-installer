...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_section_preferences_meta: 'Defaults and UI behavior for Neowow Studio.',
    ...
    installer_update_banner_title:   'Neowow Studio {version} is available',
    ...
    tab_dashboard: 'Neowow Studio Dashboard',
    ...
    sign_out: 'Sign Out',
    settings_label_shutdown: 'Stop the Neowow Studio server',
    ...
    settings_shutdown_confirm_title: 'Stop Neowow Studio',
    settings_shutdown_confirm_message: 'Stop the Neowow Studio server?',
    ...
    // Neowow-flavored default suggestion cards (label + the message sent
    // when the card is clicked — kept separate so the label can be short
    // while the prompt stays specific enough for the model).
    suggest_credits: 'Show my Coding Plan credit balance',
    suggest_skills: 'Browse the Neowow Skills market',
    suggest_deploy: 'Deploy this workspace to *.neowow.studio',
    suggest_video: 'Generate a short video',
    suggest_msg_files: 'List the files in this workspace and give me a one-line description of each.',
    suggest_msg_credits: 'Look up my Coding Plan credit usage today and show the balance broken down by cost type.',
    suggest_msg_skills: 'List popular skills on the Neowow Skills market that I have not subscribed to yet, with a one-line summary of each.',
    suggest_msg_deploy: 'Package this workspace and deploy it to *.neowow.studio. When it is live, tell me the URL.',
    suggest_msg_video: 'Generate a short video using my Coding Plan and show me the result.',
    // onboarding
    onboarding_badge: 'FIRST RUN',
    onboarding_title: 'Welcome to Neowow Studio',
    ...
    onboarding_open: 'Open Neowow Studio',
    ...
    onboarding_launch_btn: '🚀 Launch Neowow Studio',
    ...
    persona_presets_title: 'Choose a preset persona',
    persona_presets_hint: 'Click one to fill the editor below with its full persona — then edit and save.',
    persona_presets_none: 'No preset personas available.',
    persona_presets_failed: 'Failed to load preset personas.',
    persona_presets_overwrite_confirm: 'This will overwrite the current soul text. Continue?',
    persona_presets_applied: (name) => `Filled in "${name}" — remember to save`,
  ...
  folder_add_as_space_title: 'Aggiungere come Spazio?',
    ...
    settings_section_preferences_meta: 'Predefiniti e comportamento UI per Neowow Studio.',
    ...
    tab_todos: 'Todos',
    tab_insights: 'Insights',
    tab_dashboard: 'Dashboard Neowow Studio',
    ...
    sign_out: 'Esci',
    settings_label_shutdown: 'Arresta il server Neowow Studio',
    ...
    settings_shutdown_confirm_title: 'Arresta Neowow Studio',
    settings_shutdown_confirm_message: 'Vuoi arrestare il server Neowow Studio?',
    ...
    onboarding_title: 'Benvenuto in Neowow Studio',
    ...
    onboarding_open: 'Apri Neowow Studio',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    settings_section_preferences_meta: 'Neowow Studio のデフォルトと UI 動作。',
    ...
    tab_todos: 'ToDo',
    tab_insights: 'インサイト',
    tab_dashboard: 'Neowow Studio ダッシュボード',
    ...
    disable_auth: '認証を無効化',
    sign_out: 'サインアウト',
    settings_label_shutdown: 'Neowow Studio サーバーを停止',
    ...
    settings_shutdown_confirm_title: 'Neowow Studio を停止',
    settings_shutdown_confirm_message: 'Neowow Studio サーバーを停止しますか？',
    ...
    onboarding_open: 'Neowow Studio を開く',
    ...
    // ── en-fallback keys (added for locale parity; pending native translation) ──
    messaging_tab: 'Messaging',
    messaging_title: 'Messaging Channels',
    messaging_subtitle: 'Link your phone messaging apps so Hermes can chat there.',
    messaging_status_unconfigured: 'Not configured',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    tab_dashboard: 'Панель Neowow Studio',
    ...
    sign_out: 'Выйти',
    settings_label_shutdown: 'Остановить сервер Neowow Studio',
    ...
    settings_shutdown_confirm_title: 'Остановить Neowow Studio',
    settings_shutdown_confirm_message: 'Остановить сервер Neowow Studio?',
    ...
    onboarding_open: 'Открыть Neowow Studio',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    tab_dashboard: 'Panel de Neowow Studio',
    ...
    settings_label_shutdown: 'Detener el servidor Neowow Studio',
    ...
    settings_shutdown_confirm_title: 'Detener Neowow Studio',
    settings_shutdown_confirm_message: '¿Detener el servidor Neowow Studio?',
    ...
    onboarding_title: 'Bienvenido a Neowow Studio',
    ...
    onboarding_open: 'Abrir Neowow Studio',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    sign_out: 'Abmelden',
    settings_label_shutdown: 'Neowow Studio-Server stoppen',
    ...
    settings_shutdown_confirm_title: 'Neowow Studio stoppen',
    settings_shutdown_confirm_message: 'Neowow Studio-Server stoppen?',
    ...
    onboarding_title: 'Willkommen bei Neowow Studio',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    tab_todos: '待办',
    tab_insights: '统计',
    tab_dashboard: 'Neowow Studio 仪表盘',
    ...
    suggest_files: '这个工作区里有哪些文件？',
    // Neowow 特色默认卡片
    suggest_credits: '📊 查看我的 Coding Plan 积分余额',
    suggest_skills: '🛍️ 看看 Neowow 技能商店有什么新技能',
    suggest_deploy: '⚡ 把这个 workspace 部署到 *.neowow.studio',
    suggest_video: '🎬 生成一段短视频',
    suggest_msg_files: '列出当前工作区里的所有文件,并对每个文件给一行说明。',
    suggest_msg_credits: '查询我今天的 Coding Plan 积分用量,并按消耗类型分项展示当前余额。',
    suggest_msg_skills: '列出 Neowow 技能商店上我还没订阅的热门技能,每个给一行简介。',
    suggest_msg_deploy: '把当前 workspace 打包并部署到 *.neowow.studio,完成后告诉我访问 URL。',
    suggest_msg_video: '用我的 Coding Plan 帮我生成一段短视频,完成后把结果展示给我。',
    sign_out: '退出登录',
    settings_label_shutdown: '停止 Neowow Studio 服务器',
    ...
    settings_shutdown_confirm_title: '停止 Neowow Studio',
    settings_shutdown_confirm_message: '停止 Neowow Studio 服务器？',
    settings_shutdown_confirm_btn: '停止',
    ...
    onboarding_open: '打开 Neowow Studio',
    ...
    onboarding_launch_btn: '🚀 启动 Neowow Studio',
    ...
    agent_soul: '智能体灵魂',
    persona_presets_title: '从预设人格选择',
    persona_presets_hint: '点一个把它的完整人设填进下面的编辑框，你可以再修改后保存。',
    persona_presets_none: '没有可用的预设人格。',
    persona_presets_failed: '加载预设人格失败。',
    persona_presets_overwrite_confirm: '当前灵魂内容会被覆盖，确定继续？',
    persona_presets_applied: (name) => `已填入「${name}」，记得点保存`,
    no_soul_yet: '暂无灵魂定义。',
    ...
    settings_section_preferences_meta: 'Neowow Studio 的默认和 UI 行为。',
    ...
    installer_update_banner_title:   'Neowow Studio {version} 已发布',
    ...
    // Background / side-question / slash command UX (audit补齐 2026-05-27)
    bg_complete: '后台任务已完成',
    bg_failed: '后台任务失败：',
    bg_label: '后台结果：',
    bg_no_answer: '（无回复）',
    ...
    btw_done: '旁路问题已回答',
    btw_failed: '旁路问题失败：',
    btw_label: '旁路问题 — 不进入历史记录',
    btw_no_answer: '未收到回复。',
    cancel_unavailable: '当前没有可取消的操作。',
    cmd_background: '在后台运行一个 prompt',
    cmd_background_usage: '/background <prompt> — 并行后台执行,不阻塞当前会话',
    cmd_btw: '提问旁路问题（不写入历史）',
    cmd_btw_usage: '/btw <question> — 用当前会话上下文提问,但结果不写入历史',
    cmd_retry: '重发上一条消息',
    cmd_status: '查看会话状态',
    cmd_stop: '停止当前响应',
    cmd_title: '查看或设置会话标题',
    cmd_undo: '撤销上一组对话',
    cmd_voice: '切换麦克风输入',
    cmd_voice_use_mic: '请点击输入框旁的麦克风按钮。',
    cmd_webui_only_session: '此命令在从 CLI 导入的会话中不可用。',
    no_active_task: '没有可停止的任务。',
    retry_failed: '重试失败：',
    ...
    status_yes: '是',
    stream_stopped: '响应已停止。',
    title_change_hint: '用 `/title <新名称>` 重命名。',
    title_current: '当前标题',
    title_set: '标题已设置为',
    undid_messages_suffix: '条消息。',
    undid_n_messages: '已移除',
    undo_exchange: '撤销上一组对话',
    undo_failed: '撤销失败：',
    ...
    usage_settings_tip: '提示：费用预估为近似值。',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    settings_section_preferences_meta: 'Neowow Studio 的預設值與介面行為。',
    ...
    tab_todos: '待辦',
    tab_insights: '統計',
    tab_dashboard: 'Neowow Studio 儀表板',
    ...
    sign_out: '\u767b\u51fa',
    settings_label_shutdown: '\u505c\u6b62 Neowow Studio \u4f3a\u670d\u5668',
    ...
    settings_shutdown_confirm_title: '\u505c\u6b62 Neowow Studio',
    settings_shutdown_confirm_message: '\u505c\u6b62 Neowow Studio \u4f3a\u670d\u5668\uff1f',
    settings_shutdown_confirm_btn: '\u505c\u6b62',
    ...
    onboarding_open: '\u958b\u555f Neowow Studio',
    ...
    onboarding_title: '\u6b61\u8fce\u4f7f\u7528 Neowow Studio',
    onboarding_unknown: '\u672a\u77e5',
  ...
  pt: {
    ...
    settings_section_preferences_meta: 'Padrões e comportamento UI do Neowow Studio.',
    settings_section_system_title: 'Sistema',
    ...
    tab_dashboard: 'Painel Neowow Studio',
    ...
    sign_out: 'Sair',
    settings_label_shutdown: 'Parar o servidor Neowow Studio',
    ...
    settings_shutdown_confirm_title: 'Parar Neowow Studio',
    settings_shutdown_confirm_message: 'Parar o servidor Neowow Studio?',
    ...
    onboarding_title: 'Bem-vindo ao Neowow Studio',
  ...
  ko: {
    ...
    settings_section_preferences_meta: 'Neowow Studio의 기본값과 UI 동작.',
    ...
    tab_todos: 'Todos',
    tab_insights: '통계',
    tab_dashboard: 'Neowow Studio 대시보드',
    ...
    sign_out: '로그아웃',
    settings_label_shutdown: 'Neowow Studio 서버 중지',
    ...
    settings_shutdown_confirm_title: 'Neowow Studio 중지',
    settings_shutdown_confirm_message: 'Neowow Studio 서버를 중지할까요?',
  ...
  fr: {
    ...
    settings_section_preferences_meta: 'Paramètres par défaut et comportement de l\'interface utilisateur pour Neowow Studio.',
    ...
    settings_label_shutdown: 'Arrêter le serveur Neowow Studio',
    ...
    settings_shutdown_confirm_title: 'Arrêter Neowow Studio',
    settings_shutdown_confirm_message: 'Arrêter le serveur Neowow Studio ?',
  ...
  tr: {
    ...
    settings_section_preferences_meta: 'Neowow Studio için varsayılanlar ve Kullanıcı Arayüzü davranışı.',
    ...
    tab_dashboard: 'Neowow Studio Kontrol Paneli',
    ...
    settings_label_shutdown: 'Neowow Studio sunucusunu durdur',
    ...
    settings_shutdown_confirm_title: 'Neowow Studio\'yi durdur',
    settings_shutdown_confirm_message: 'Neowow Studio sunucusu durdurulsun mu?',
    ...
    onboarding_open: 'Neowow Studio\'i aç',
