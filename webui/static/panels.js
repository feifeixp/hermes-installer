...
// The legacy single-list Skills functions (loadSkills / renderSkills /
// _toggleCatCollapse / filterSkills / toggleSkill, plus _collapsedCats
// state) were removed in the 3-tab rewrite. Implementation now lives
// below in _skillsState / loadSkillsPanel / renderSkillsPanel.
// _profileSwitchPanelLoad calls loadSkillsPanel() to match.
...
async function _profileSwitchPanelLoad(){
  // Neowow distribution: 3-tab Skills panel exposes its loader as
  // loadSkillsPanel (the upstream loadSkills was removed in our rewrite).
