...
# ── Watchtower (auto-update of hermes-webui) ──────────────────────────
# Defaults below — edit + `docker compose up -d watchtower` to apply.
WATCHTOWER_POLL_INTERVAL=3600
WATCHTOWER_TZ=Asia/Shanghai
# Optional: notification URL (Slack/Telegram/email/webhook). See
# https://containrrr.dev/watchtower/notifications/ for URL formats.
