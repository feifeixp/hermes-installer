...
# (Default-personality seeding moved to webui/server.py:_seed_default_personalities — see git history.)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not (changed_auth or changed_prov):
        print("[patch] No changes needed (provider already present).")
        return 0
